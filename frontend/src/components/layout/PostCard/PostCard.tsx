...
function PostCard ({title, content, type}: Props) {
	...
	const addPostCard = () => {
		...
		// @ts-ignore
		newPostCards.push(<PostCard title={'OLA'} content={'xdxdxdxd'} type={1} />);
		...
		<div className="postCard">
			...
			<div className="postCardButtonOutsideContainer">
				<div className="postCardButtonInerContainer">
					...
					<button id="postCardShare" className="postCardActionButton" type="button" onClick={handleShowAlert}/>
